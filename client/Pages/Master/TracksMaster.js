...
export default function Tracks({ navigation }) {
  ...
  const vizualizar = (course) => {
    navigation.navigate('InformacoesTracksMaster', { courseToSee: course });
  };
    ...
    useCallback(() => {
      async function fetchData() {
        try {
          ...
          Alert.alert('Erro', 'Não foi possível carregar a lista de tracks');
        }
      }
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.Botão}>
          <TouchableOpacity style={styles.VerMaisBTN}  onPress={() => navigation.navigate('CadastroTrackMaster')}>
