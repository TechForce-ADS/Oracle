...
const CadastrarConsultor = ({ navigation }) => {
    ...
    const handleRegister = async () => {
        try {
            const response = await fetch(`http://${ip}:3001/api/admin/register`, {
                ...
                body: JSON.stringify({ email, name, password, isConsultant }),
            });
            ...
            <Navbar />
                ...
                <View style={styles.ContainerLogin}>
                    <View style={styles.Textos}>
                        <Text style={{ fontSize: 26, color: '#fff', fontFamily: 'Poppins_700Bold', textAlign: 'center' }}>Novo Consultor</Text>
...
CadastrarConsultor.navigationOptions = {
    title: 'CadastrarConsultor',
}
