...
const Admin = ({ navigation }) => {
  ...
  const vizualizar = (admin) => {
    navigation.navigate('InformacoesAdminMaster', { adminToSee: admin });
  };
    ...
    <View style={{ flex: 1, backgroundColor: '#1c2120', alignItems: 'center' }}>
      ...
      <ScrollView>
            ...
            <View style={styles.container}>
              ...
              <View style={styles.TextName}>
                ...
                <Text style={{ fontSize: 12, color: '#FFF', letterSpacing: 1, fontFamily: 'Poppins_700Bold' }}>
                  {admin.isConsultant ? 'Consultor' : 'Administrador'}
                </Text>
        ...
        <View style={styles.Botao}>
              <TouchableOpacity style={styles.EditarBTN} onPress={() => navigation.navigate('AdicionarAdministrador')}>
                <Text style={{ color: '#000', textAlign: 'center', fontSize: 16, fontFamily: 'Poppins_700Bold' }}> + Adicionar Administrador</Text>
              </TouchableOpacity>
            </View>
      </ScrollView>
    </View>
