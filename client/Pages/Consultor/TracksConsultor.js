...
export default function Tracks({ navigation }) {
  ...
  const vizualizar = (course) => {
    navigation.navigate('InformacoesTracksConsultor', { courseToSee: course });
  };
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.Botão}>
          <TouchableOpacity style={styles.VerMaisBTN}  onPress={() => navigation.navigate('CadastroTrackConsultor')}>
