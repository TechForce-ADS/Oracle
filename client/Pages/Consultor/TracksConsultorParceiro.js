...
export default function TracksConsultorParceiro({ navigation, route }) {
  ...
  const vizualizar = (course) => {
    navigation.navigate('InformacoesTracksConsultorParceiro', { courseToSee: course, partnerToSee: partnerData });
  };
